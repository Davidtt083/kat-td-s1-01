...
function funcion1() {
 ...
 function funcion4() {
  ...
  function funcion5() {
	...
	var btn3 = document.getElementById('btn5');
	var circint = document.getElementById('btnint4');
	var starttime = 12;
	var endtime = 14;
	btn1.classList.remove('btncirc');
	btn1.classList.add('btn');
 ...
 function funcion6() {
	...
	var vid2 = document.getElementById('video5');
	var vid3 = document.getElementById('videof6');
	var vid4 = document.getElementById('videof7');
	var btn1 = document.getElementById('btn1');
	var btn3 = document.getElementById('btn5');
	var starttime = 14;
	var endtime = 16;
	...
	btn1.setAttribute('onclick','funcion7()');
	btn3.removeAttribute('onclick');
	vid2.classList.add('hide');
	vid.classList.remove('hide');
	vid3.classList.add('hide');
